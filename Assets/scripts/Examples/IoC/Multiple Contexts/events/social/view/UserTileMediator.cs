...
using UnityEngine;
using strange.examples.multiplecontexts.events.game;
using strange.extensions.dispatcher.eventdispatcher.impl;
using strange.extensions.mediation.impl;

namespace strange.examples.multiplecontexts.events.social {
    public class UserTileMediator : EventMediator<UserTileView> {

        [Inject] public UserVO userVO { get; set; }
