...
namespace strange.extensions.injector.impl {
    public class InjectionBinder : Binder, IInjectionBinder {
        ...
        public override void SetBinderName(string binderName) {
            base.SetBinderName(binderName);
            injector.reflector.SetBinderName("Reflection binder for " + GetBinderName());
        }
        ...
        new public virtual IInjectionBinding Rebind<T>() {
            return GetBinding<T>() ?? Bind<T>();
        }

        public virtual IInjectionBinding Rebind(Type key) {
