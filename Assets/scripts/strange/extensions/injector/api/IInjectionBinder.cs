...
namespace strange.extensions.injector.api {
    public interface IInjectionBinder {
        ...
        void SetBinderName(string name);
        string GetBinderName();
        void IterateAllBindings(Action<object, object, IBinding> callback);

        // Bind anew or get existing binding for key, safely bind
        IInjectionBinding Rebind<T>();
        IInjectionBinding Rebind(Type key);
        IBinding Rebind(object key);
