...
namespace strange.examples.multiplecontexts.signals.game {
    public class ShipSignalMediator : EventMediator<ShipSignalView> {
        ...
        [Inject] public SHIP_DESTROYED SHIP_DESTROYED { get; set; }
        [Inject] public MAIN_REMOVE_SOCIAL_CONTEXT MAIN_REMOVE_SOCIAL_CONTEXT { get; set; }
