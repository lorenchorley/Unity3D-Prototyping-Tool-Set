...
namespace strange.examples.multiplecontexts.signals.social {
    public class GoogleService : ISocialService {
        ...
        [Inject] public Signal<UserVO> FULFILL_CURRENT_USER_REQUEST { get; private set; }
        [Inject] public Signal<ArrayList> FULFILL_FRIENDS_REQUEST { get; private set; }

        public GoogleService() {
            FULFILL_CURRENT_USER_REQUEST = new Signal<UserVO>();
            FULFILL_FRIENDS_REQUEST = new Signal<ArrayList>();
        }

        public void FetchCurrentUser() {
            MonoBehaviour root = contextView.GetComponent<SocialSignalRoot>();
        ...
        private IEnumerator waitASecondThenReturnFriendList() {
            ...
            FULFILL_FRIENDS_REQUEST.Dispatch(friends);
        }
