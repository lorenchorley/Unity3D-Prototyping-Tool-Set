...
namespace strange.examples.multiplecontexts.events.main {
    public class StartCommand : EventCommand {

        [Inject(ContextKeys.CONTEXT_VIEW)] public GameObject contextView { get; set; }

        public override void Execute() {
            dispatcher.Dispatch(MainEvent.LOAD_SCENE, "game-events");
            dispatcher.Dispatch(MainEvent.LOAD_SCENE, "social-events");
        }
